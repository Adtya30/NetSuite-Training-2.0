...
//    		Returns the number of lines in a sublist.
    		var item = currentRecord.getLineCount({
    			sublistId : 'item'
    		});
    		...
    		for( var lineCount = 0;lineCount < item; lineCount++){
    			...
    			if(totalQuantity > 10){
    				var itemFullfillment1 = currentRecord.setValue({
    					fieldId : 'custbody_quantity_item_ad',
    					value : 1,
    					ignoreFieldChange : true
    				});
    			}else if((totalQuantity < 10)){
    				var itemFullfillment2 = currentRecord.setValue({
    					fieldId : 'custbody_quantity_item_ad',
    					value : 2,
    					ignoreFieldChange : true
    				});
    			}else{
    				var itemFullfillment3 = currentRecord.setValue({
    					fieldId : 'custbody_quantity_item_ad',
    					value : 3,
    					ignoreFieldChange : true
    				});
